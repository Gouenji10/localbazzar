...
class Auth extends Core_Controller
{
	...
	{		
		...
		{
			if($this->input->is_ajax_request()){
				$login=$this->do_login($email,$password);
				if($login){
					echo "success";
					exit();
				}
		...
		{
			if($this->input->is_ajax_request()){
				$response = json_encode(validation_errors());
				if(strpos($response,'unique')){
					echo "Email Address Already Registered.";
				}else{
					echo "Please Check All the Input Fields & Please Try Again.";
				}
				exit();
